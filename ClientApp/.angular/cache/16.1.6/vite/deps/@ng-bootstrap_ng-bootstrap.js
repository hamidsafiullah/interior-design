...
var VERSION = new Version("16.1.7");
...
var _NgbTimepicker = class {
  ...
  updateMinute(newVal) {
    var _a;
    (_a = this.model) == null ? void 0 : _a.updateMinute(toInteger2(newVal));
    this.propagateModelChange();
  }
  /**
  ...
  updateSecond(newVal) {
    var _a;
    (_a = this.model) == null ? void 0 : _a.updateSecond(toInteger2(newVal));
    this.propagateModelChange();
  }
  toggleMeridian() {
    if (this.meridian) {
